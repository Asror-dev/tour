package org.example.tour.security.service.impl;
...
public class JwtServiceImpl implements JwtService {
    ...
    @Override
    public SecretKey signWithKeyRefresh(){
        final String SECRET_KEY="shiftacademyqabulsaytiuchunmaxsusrefreshtokenuchun";
        byte[] decode = Decoders.BASE64.decode(SECRET_KEY);
        return Keys.hmacShaKeyFor(decode);
    }
